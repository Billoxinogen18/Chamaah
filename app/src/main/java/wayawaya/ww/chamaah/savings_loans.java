...
public class savings_loans extends AppCompatActivity {
...
protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.savings_loans);



    notificationCount1 = (RelativeLayout) findViewById(R.id.notification_layout);

        getSupportActionBar().setTitle("Savings& Loans"); // for set actionbar title
                    ...
                    public void onClick(View view) {
                        ...
                        alertDialog.setButton(Dialog.BUTTON_POSITIVE,"Add Card", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent = new Intent(savings_loans.this, add_card.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(savings_loans.this, MainActivitySearch.class);
